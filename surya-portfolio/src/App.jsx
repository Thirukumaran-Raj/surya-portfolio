    ...
    <div>
      ...
      <section id="contact">
        ...
        <div className="card">
          ...
          <p><strong>LinkedIn:</strong> <a href="https://linkedin.com/in/surya-s-33039828" target="_blank" rel="noreferrer" style={{ color: '#3b82f6', textDecoration: 'none' }}>linkedin.com/in/surya-s-33039828</a></p>
        </div>
      </section>
